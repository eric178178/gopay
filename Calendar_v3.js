...
document.writeln('<div id="__calendarPanel" style="position:absolute;display:none;z-index:9999;background-color:#FFFFFF;border:1px solid #dfdfdf;width:250px;height:260px;border-radius:1px;box-shadow: 0 0 3px #1e1d1d;">');
...
__ci.document.writeln('td.normal {background-color:#EFEFEF;padding:8px;}');
